...
\end{equation}
where we employ fourth-order hyper-dissipation ($\nabla^4$ operator, damping $\propto k^4$) to maintain numerical stability while preserving an extended inertial range. For the $64^3$ resolution, enhanced dissipation ($\eta = 20$) is required to suppress a numerical instability at this specific resolution.
