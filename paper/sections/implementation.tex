...
The repository employs semantic versioning. Current development focuses on extending the physics model (finite Larmor radius corrections, electromagnetic temperature variations) and improving performance (better FFT libraries, multi-GPU parallelization via \texttt{jax.pmap} for data-parallel parameter scans across GPUs). Community contributions addressing bugs, documentation improvements, or new features follow standard GitHub pull-request workflows.
