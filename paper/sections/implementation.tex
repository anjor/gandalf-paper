...
\item \textbf{Physics parameters}: Plasma beta $\betai$, temperature ratio $\taue = T_e/T_i$, moment truncation $\Mmax$
...
The resulting ecosystem serves diverse needs: GANDALF for accessible turbulence research and rapid prototyping, specialized codes (AstroGK, GS2, GENE, GX) for comprehensive physics and production-scale campaigns, and open-source implementations enabling reproducible science across the community.
