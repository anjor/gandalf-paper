...
We employ Gaussian centimeter-gram-second (CGS) units for the dimensional equations in this subsection. KRMHD evolves two coupled systems: the Elsasser fields $\xi^\pm$ (where $\xi^+ = \elsp$ and $\xi^- = \elsm$) representing counter-propagating \Alfven\ wave packets, and the kinetic distribution $g^\pm$ describing compressive fluctuations. The Elsasser fields satisfy
\begin{equation}
