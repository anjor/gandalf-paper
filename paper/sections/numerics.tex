...
\hat{w}^-_{n+1/2} &= e^{-ik_z\vA\Delta t/2}\left(\hat{w}^-_n + e^{-ik_z\vA\Delta t/2} \frac{\Delta t}{2} \widehat{\mathcal{N}_n^-}\right)
\end{align*}
\STATE Hermite moments (no integrating factor, RHS from Eq.~\eqref{eq:moment_hierarchy}):
\[
