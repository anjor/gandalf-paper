...
\textbf{Development environment}: Claude was accessed through two interfaces---the Claude App for brainstorming and planning, and Claude Code CLI for implementation sessions. The Claude GitHub App provided automated code review on pull requests. The codebase used JAX running on Apple Silicon's Metal backend.
...
Lines of \LaTeX\ (both papers) & $\sim$1,700 \\
