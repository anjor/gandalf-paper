...
\fill[highcolor!80] (9.5, -0.2) rectangle (10, 0.2);
\node[anchor=west, font=\footnotesize] at (10.1, 0) {High ($>$60\%)};
\fill[midcolor!80] (9.5, -0.8) rectangle (10, -0.4);
\node[anchor=west, font=\footnotesize] at (10.1, -0.6) {Medium (30--60\%)};
\fill[lowcolor!80] (9.5, -1.4) rectangle (10, -1.0);
\node[anchor=west, font=\footnotesize] at (10.1, -1.2) {Low ($<$30\%)};
